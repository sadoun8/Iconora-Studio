...
Source: "{#SourcePath}\installers\third_party\vcredist_x64.exe"; DestDir: "{tmp}"; Flags: dontcopy; Check: FileExistsExpand('{#SourcePath}\\installers\\third_party\\vcredist_x64.exe')
